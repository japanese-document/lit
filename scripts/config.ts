...
export const CSS_PATH = '/lit/app.css?v=001'
export const BASE_URL = 'https://japanese-document.github.io/lit'
...
export const INDEX_PAGE_TITLE = 'Lit'
export const INDEX_PAGE_DESCRIPTION = 'JavaScriptのWeb UI フレームワーク'
